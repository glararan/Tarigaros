...
ChatCommand* ChatHandler::getCommandTable()
{
    ...
    {
        { "plus",           SEC_PLAYER,         true,   OldHandler<&ChatHandler::HandleRepAddCommand>,   "", NULL },
        { "minus",          SEC_PLAYER,         true,   OldHandler<&ChatHandler::HandleRepDelCommand>,   "", NULL },
        { "prehled",        SEC_PLAYER,         true,   OldHandler<&ChatHandler::HandleRepInfoCommand>,  "", NULL },
